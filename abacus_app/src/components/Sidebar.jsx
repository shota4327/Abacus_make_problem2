 ...
 * @param {number|string} props.currentTab - 現在アクティブなタブ ID (0-9:見取り算各問, 'multiplication', 'division', 'manager')
 * @param {Function} props.onTabChange - タブ切り替え通知ハンドラー (tabKey) => void
 * @returns {JSX.Element} サイドバー描画要素
 */
