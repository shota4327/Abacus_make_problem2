...
import { ConditionPanelProps } from '../types';
...
const ConditionPanel: React.FC<ConditionPanelProps> = ({
    ...
    const handleSelect = (val: number | null | 'R') => {
        ...
        if (activeSelector === 'plusOne') setPlusOneDigit(finalVal);
    ...
    const renderDigitSelector = (type: string, currentVal: number | null) => {
    ...
    const renderRangeDigitSelector = (minType: string, minVal: number | null, maxType: string, maxVal: number | null) => (
