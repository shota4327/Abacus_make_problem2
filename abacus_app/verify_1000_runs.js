/**
 * verify_1000_runs.js (abacus_app)
 * 
 * 要件 R4 を満たす 1,000回連続問題生成自動検証テストスクリプト (E2E)
 */

import { generateDivisionProblems } from './src/utils/divisionGenerator.js';
...
// 直接実行の場合
if (import.meta.url === `file://${process.argv[1]}` || process.argv[1].endsWith('verify_1000_runs.js')) {
    runVerification();
}
